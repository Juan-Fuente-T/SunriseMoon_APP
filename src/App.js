...
function App() {
  ...
  return (
    <ChakraProvider>
      <Box p='3' mx="auto" maxW="600px" height={['1020px', '790px']} backgroundColor={'#262626'} display="flex" flexDirection="column" justifyContent="center" alignItems={'center'} marginY="auto">
