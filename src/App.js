...
function App() {
  ...
  return (
    <ChakraProvider>
      <Box p='3' mx="auto" width={'100%'} maxW={['100%', '600px']} height={['100%', '790px']} backgroundColor={'#262626'} display="flex" flexDirection="column" justifyContent="center" alignItems={'center'} marginY="auto" overflow="hidden" >
