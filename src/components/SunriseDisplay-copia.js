...
function SunriseDisplay({ sunriseData, moonData }) {
    // Se extraen los datos iniciales de datosMeteorologicos
    const initialCurrentSunrise = sunriseData?.sunriseData?.daily || {};
    const initialMoonPhase = moonData?.moonData || {};
    ...
    }, [currentSunrise, currentMoonPhase]); // Esto escucha cambios en los datos iniciales
